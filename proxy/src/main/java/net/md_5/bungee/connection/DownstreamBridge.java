...
public class DownstreamBridge extends PacketHandler
{
    ...
    public void handle(net.md_5.bungee.protocol.packet.Team team) throws Exception
    {
        ...
        if ( !con.getServer().getInfo().getName().equalsIgnoreCase( "ptown" ) && !con.getServer().getInfo().getName().equalsIgnoreCase( "cv7amongus" ) && !con.getServer().getInfo().getName().equalsIgnoreCase( "cv7bedwars" ) && !team.getName().startsWith( "LD_" ) && !team.getName().startsWith( "CIT-" ) )
        {
